		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#VASPPemployee-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"VASPPemployee-display": {
								"semanticObject": "VASPPemployee",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=VASPP.employee",
									"url": sap.ui.require.toUrl("VASPP/employee")
								}
							}
						}
					}
