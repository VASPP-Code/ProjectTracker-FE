		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Vendor Page",
									"targetURL": "#vaspptracker-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"vaspptracker-display": {
								"semanticObject": "vaspptracker",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=vaspp.tracker",
									"url": sap.ui.require.toUrl("vaspp/tracker")
								}
							}
						}
					}
