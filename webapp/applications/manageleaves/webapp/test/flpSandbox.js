		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "manageleaves",
									"targetURL": "#VASPPmanageleaves-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"VASPPmanageleaves-display": {
								"semanticObject": "VASPPmanageleaves",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=VASPP.manageleaves",
									"url": sap.ui.require.toUrl("VASPP/manageleaves")
								}
							}
						}
					}
