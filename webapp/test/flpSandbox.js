		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "user login",
									"targetURL": "#vasppuserlogin-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"vasppuserlogin-display": {
								"semanticObject": "vasppuserlogin",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=vaspp.userlogin",
									"url": sap.ui.require.toUrl("vaspp/userlogin")
								}
							}
						}
					}
